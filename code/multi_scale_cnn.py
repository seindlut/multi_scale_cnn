...
def train_cifar10(datapath, dataset_name,
    ...
    validate_set = unpickle('/home/ramp/lishaohua/obj_detection/DeepLearningTutorials/data/cifar10/test_batch')
...
#    layer2_5 = HiddenLayer(
#       rng,
#       input=layer2.output,
#       n_in=hidden_nodes,
#       n_out=hidden_extra_nodes,
#       activation=T.tanh
#    )
...
#    layer3 = LogisticRegression(input=layer2_5.output, n_in=hidden_extra_nodes, n_out=10)

#    total_cost = layer3.negative_log_likelihood(y) + penalty_coeff*(layer2.W.norm(2) + layer2_5.W.norm(2))
...
#    params = layer3.params + layer2_5.params + layer2.params + layer1_sub.params + layer1.params + layer0_sub.params + layer0.params

    grad_l3     = T.grad(total_cost, layer3.params)
    grad_l2     = T.grad(total_cost, layer2.params)

#    grad_l2_5   = T.grad(total_cost, layer2_5.params)
...
#        (layer2_5.params[0]  , layer2_5.params[0]   - learning_rate * grad_l2_5[0])  ,
#        (layer2_5.params[1]  , layer2_5.params[1]   - learning_rate * grad_l2_5[1])  ,
    ...
    train_model = theano.function(
        ...
        updates=updates,
        givens={
            x : shared_x[training_index * 10000 : (training_index+1) * 10000],
            y : shared_y[training_index * 10000 : (training_index+1) * 10000]
        }
    )
    ...
    test_model = theano.function(
        ...
        layer3.errors(y),
        givens={
#            x: shared_x[40000:50000],
#            y: shared_y[40000:50000]
            x: evalset_x,
            y: evalset_y
        }
    )
...
#        cost_ij, error = train_validation()
